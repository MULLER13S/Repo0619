...
<head>
    ...
    <link href="<?php echo BACKEND09_CSS_URL; ?>User_Login.css" type="text/css" rel="stylesheet" />
...
<!--                                    <img src="--><?php //echo BACKEND09_IMG_URL;?><!--admin.png"  alt="" />-->
<!--                                </li>-->
<!--                            </ul>-->
                        </div>
                    </li>
                    <li class="user_main_r">
                        ...
                        <input style="border: medium none; background: url('<?php echo BACKEND09_IMG_URL; ?>user_botton.gif') repeat-x scroll left top transparent; height: 122px; width: 111px; display: block; cursor: pointer;" value="" type="submit">
                    </li>
                </ul>
            <?php $this -> endWidget(); ?>
