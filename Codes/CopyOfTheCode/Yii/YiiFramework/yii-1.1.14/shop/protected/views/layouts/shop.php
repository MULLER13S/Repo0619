    ...
    <div id="topNav" class="clearfix">
        <div style="float: left;">
            ...
            <?php } else {?>
                <font id="ECS_MEMBERZONE">
                    <div id="append_parent"></div>
<!--                    <font class="f4_b">--><?php //echo Yii::app()->user->name; ?><!--</font>-->
                    <font class="f4_b"><?php $this->renderDynamic('show_name'); ?></font>
                    , 欢迎您回来！
                    <a href="#">用户中心</a>
...
<div id="bottomNav" class="box block">
    <div class="box_1">
        <div class="links clearfix">
            <a href="#" target="_blank" title="YONGDA商城"><img src="<?php echo IMG_URL; ?>ecmoban.gif" alt="YONGDA商城" border="0"></a>

            <a href="#" target="_blank" title="YONGDA 网上商店管理系统">
                <img src="<?php echo IMG_URL; ?>logo.gif" alt="YONGDA 网上商店管理系统" border="0" />
            </a>
