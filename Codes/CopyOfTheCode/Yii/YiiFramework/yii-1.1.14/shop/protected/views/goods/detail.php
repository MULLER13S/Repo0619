...
<div class="block box">
    <div class="blank"></div>
    <div id="ur_here">
        当前位置: <a href="#">首页</a> <code>&gt;</code> <a href="#">手机类型</a> <code>&gt;</code> <a href="#">GSM手机</a> <code>&gt;</code> <?php echo $goods_info->goods_name;?>
    </div>
</div>
<div class="blank"></div>
            ...
            <div class="textInfo">
                <form action="javascript:addToCart(9)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY">
                    ...
                    <ul>
                        ...
                        <li class="clearfix">
                            <dd>
                                <strong>商品品牌：</strong><a href="#"><?php echo $goods_info->goods_name;?></a>
                            </dd>
                        </li>
                        <li class="clearfix">
                            <dd>
