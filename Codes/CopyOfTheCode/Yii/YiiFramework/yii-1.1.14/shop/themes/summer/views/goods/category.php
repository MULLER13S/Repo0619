...
<div class="header_bg_b" style="background-color: green">
                    ...
                    <form name="compareForm" action="compare.php" method="post" onsubmit="return compareGoods(this);">
                        <div class="clearfix goodsBox" style="border: medium none; padding: 11px 0pt 10px 5px;">
                            ...
                            foreach ($goods_infos as $_v ) {
                                ...
                                <div class="goodsItem">
                                    <a href="./index.php?r=goods/detail&id=<?php echo $_v->goods_id;?>"
                                       target="_blank"><img src="<?php echo $_v->goods_big_img;?>"
                                                            alt="<?php echo $_v->goods_name;?>" class="goodsimg"></a><br/>

                                    <p><a href="#" title="诺基亚N85"><?php echo $_v->goods_name;?></a></p>
                                    <font class="market_s"><?php echo $_v->goods_price;?></font><br/>
                                    <font class="shop_s"><?php echo $_v->goods_price;?></font><br/>
